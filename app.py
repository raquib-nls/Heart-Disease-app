...
Fasting_bs = st.selectbox('Fasting bs >120 mg/dL',['Choose any',0,1])
Resting_ecg = st.selectbox('Rsting_Ecg ',['Choose any','Normal','ST',"LVM"])
Max_hr = st.slider('Max Heart Rate',60,220,150)
exercise_agina = st.selectbox('exercise-induces- Agina ',['Choose any','Y','N'])
